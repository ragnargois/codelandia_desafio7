...
function shareContent() {
    if (navigator.share) {
      navigator.share({
        ...
        text: 'Confira a landing page de Valorant, criada por Alex Gois para o desafio 7 da comunidade Codelândia no Discord.',
        url: 'https://github.com/ragnargois/codelandia_desafio7.git',
      }).then(() => {
